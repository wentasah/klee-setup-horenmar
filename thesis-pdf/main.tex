...
\note{It is approximately 200 lines} which was solved by using a hack provided
on the KLEE mailing list.\cite[wlllvm-patch] Afterwards I was able to compile
