...
The results from testing the MaCAN library are mixed. On one hand, KLEE has
helped found a critical bug, confirmed a found bug and helped find a currently
dormant bug in the MaCAN implementation of the library. On the other, after
running for more than 5 days, KLEE has not completely finished running the
test.
