...
respectively. We wil use Clang-3.3 as our LLVM IR compiler.
...
Figure~\ref[diffstat] shows "diffstat" results of my work in the MaCAN
repository, minus boilerplate files of MaCAN's build system.
...
Figure~\ref[macan-crypto-patch] shows patch that was also needed in the general
MaCAN implementation of "cryptlib.c".
