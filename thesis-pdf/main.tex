...
\shortcitations %probably unneeded and already used by opmac-bib
...
\rfc{Make these paragraphs flow together better.}
...
message security as part of the communication protocol. The advantage of MaCAN
protocol here is that it builds upon the CAN bus and is backwards compatible
with already deployed CAN networks.

The MaCAN library itself was designed to be crossplatform by only having single,
