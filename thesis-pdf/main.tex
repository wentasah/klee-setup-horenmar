...
* Division by zero
* Overshift (shifting and integer by more than its size)
\enditems

Recently, KLEE was also extended to handle integer oveflow
checking, as detailed in the next section.
...
one was in the UB territory and another caused a bug found independently.
