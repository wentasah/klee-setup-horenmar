...
KLEE takes a file of LLVM IR its input and works directly on the LLVM IR. It is
capable of interpreting a large subset of the language, that does not include
symbolic floating point, threads, "longjmp", embedded assembly code and some
intrinsics. All memory objects also have to have concrete size.
