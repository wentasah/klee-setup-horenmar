...
\midinsert \clabel[klee-runs]{Overview of KLEE runs results}
\ctable{lr}{
...
Table~\ref[klee-runs] shows an overview of KLEE runs and number of potential
bugs they reported, and Figure~\ref[klee-runs-stats] shows their runtime
statistics.
