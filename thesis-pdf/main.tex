...
\rfc{The rest is organized as follows... bla bla bla}
...
(they are marked with ">>" in the figure). There are 13 messages that we need
...
initial initialization and then 17 messages extra. This means that our testing
harness could exercise all paths through the MaCAN library, except those that
make use of cryptographic primitives.
...
>>0.009 82064E4E5EBA1956 crypt KS(me)->S (0->2): sess_key seq=0 len=6
>>0.009 8216FC6195514DEF crypt KS(me)->S (0->2): sess_key seq=1 len=6
>>0.009 822697F3A6F61D43 crypt KS(me)->S (0->2): sess_key seq=2 len=6
>>0.009 8236DAA3670B3B3A crypt KS(me)->S (0->2): sess_key seq=3 len=6
>>0.009 8246E56447E117DE crypt KS(me)->S (0->2): sess_key seq=4 len=6
>>0.009 8252C6FC47E117DE crypt KS(me)->S (0->2): sess_key seq=5 len=2
  0.009 4100F14494135731 crypt S->TS (2->1): challenge fwd_id=KS(me)
>>0.010 82062D7CE15B64DA crypt KS(me)->S (0->2): sess_key seq=0 len=6
>>0.010 8216C27453EBA9AD crypt KS(me)->S (0->2): sess_key seq=1 len=6
>>0.010 8226344BCF27EAF9 crypt KS(me)->S (0->2): sess_key seq=2 len=6
>>0.010 8236C1486C993615 crypt KS(me)->S (0->2): sess_key seq=3 len=6
>>0.010 8246DD2249DF4E4A crypt KS(me)->S (0->2): sess_key seq=4 len=6
>>0.010 82528F6249DF4E4A crypt KS(me)->S (0->2): sess_key seq=5 len=2
...
happen only theoretically, or they were intended. Two examples of such follow.
\begtt
...
Another difficulty when using KLEE to test software is the time it needs to
...
\rfc{How many messages were sent versus how many are actually needed}
\rfc{Work KLEE's runtime statistics into the section.}
\rfc{Note that it created xy states?}
