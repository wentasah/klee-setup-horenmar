...
but the software has to be designed with using KLEE in mind.}
...
systémů. Došli jsme k závěru, že KLEE může být cenný nástroj pro verifikaci
...
evaluate its fitness for testing safety-critical software.
...
is mitigated by the fact that safety-related software contains relatively
...
safety-critical software, symbolic execution and existing tools using it,
the tool I am using in this thesis and the two pieces of safety-critical
software we will use to evaluate KLEE's fitness for purpose. Third chapter,
Toolchain and case study preparation, covers work done KLEE, eMotor software
...
severity, time it took to find them and whether KLEE will be useful tool for
testing safety-critical real-time software going forward. The final chapter,
