...
This section explains basic usage of KLEE. We will go through running KLEE on
...
We wil use Clang-3.3 as our LLVM IR compiler.
...
\midinsert \clabel[diffstat]{{\tt diffstat} of my work on MaCAN library}
\begtt
 ...
 macan/src/macan.c              |    6 +-
\endtt
\caption/f {\tt diffstat} of my work on MaCAN library.
\endinsert
...
\begtt
/**
 * Simplifies cmac -> message is automagically going to have both the
 * correct and the incorrect cmac anyway.
 */
