...
\midinsert \clabel[klee-runs]{Table of KLEE runs}
\ctable{lr}{
...
Taking these facts into regard together with results of testing from Chapter 4,
I came to recommend using KLEE command line invocation from Figure~\ref[klee-cmd].
