...
and property damage, and more people rely on it every day. It is characterized
by being thoroughly tested and reliable, but as the Internet of Things is
becoming more and more pervasive, there can be no safety without security,
as shown with the recent example of being able to locate and unlock Tesla
...
This has led us to use a tool oriented towards finding bugs in general and
evaluate its fitness for testing safety-related software.

The tool we decided to use is symbolic execution, namely
KLEE~\cite[klee-paper], because symbolic execution is generally sound and
its main drawbacks, exponential runtime complexity in number of branches,
are mitigated by the fact that safety-related software contains relatively
low number of paths through its code. While no tool can prevent security
